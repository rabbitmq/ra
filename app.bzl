...
def all_test_beam_files(name = "all_test_beam_files"):
    filegroup(
        ...
        srcs = [
            ...
            "test/ra_app.beam",
            "test/ra_bench.beam",
            "test/ra_counters.beam",
            "test/ra_dbg.beam",
            "test/ra_directory.beam",
            "test/ra_env.beam",
            "test/ra_file_handle.beam",
            "test/ra_flru.beam",
            "test/ra_leaderboard.beam",
            "test/ra_lib.beam",
            "test/ra_log.beam",
            "test/ra_log_ets.beam",
            "test/ra_log_meta.beam",
            "test/ra_log_pre_init.beam",
            "test/ra_log_reader.beam",
            "test/ra_log_segment.beam",
            "test/ra_log_segment_writer.beam",
            "test/ra_log_snapshot.beam",
            "test/ra_log_sup.beam",
            "test/ra_log_wal.beam",
            "test/ra_log_wal_sup.beam",
            "test/ra_machine.beam",
            "test/ra_machine_ets.beam",
            "test/ra_machine_simple.beam",
            "test/ra_metrics_ets.beam",
            "test/ra_monitors.beam",
            "test/ra_server.beam",
            "test/ra_server_proc.beam",
            "test/ra_server_sup.beam",
            "test/ra_server_sup_sup.beam",
            "test/ra_snapshot.beam",
            "test/ra_sup.beam",
            "test/ra_system.beam",
            "test/ra_system_sup.beam",
            "test/ra_systems_sup.beam",
        ],
    )
    erlang_bytecode(
